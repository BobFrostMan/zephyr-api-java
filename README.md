...
This project provides a simple and convenient Java client for interacting with the Zephyr API. It is designed to
simplify the integration of your Java applications (mainly test automation frameworks) with Zephyr, allowing you to
programmatically manage test cases, folders, statuses, priorities, and other resources.

## Motivation

I didn't find user-friendly not overloaded with internal entities and api logic client for simple Zephyr actions. So
it's an attempt to design a simple client for Zephyr without additional headache.
...
By using this project or its source code, for any purpose and in any shape or form, you grant your **implicit
agreement** to all the following statements:
...
Java 11 or later. Generated
Zephyr [access token](https://support.smartbear.com/zephyr/docs/en/rest-api/api-access-tokens-management.html).
...
```gradle
implementation 'io.github.bobfrostman:zephyr-scale-java-client:1.2.2' // Replace with the actual version
```
...
You will also
need [generated access token](https://support.smartbear.com/zephyr/docs/en/rest-api/api-access-tokens-management.html)
to reach Zephyr API.
...
Creates a new testcase in specified folder. Folder can be specified by folderId, or folderPath. If folder path doesn't
...
If the project has test case custom fields, all custom fields should be present in the request. To leave any of them
blank, please set them null if they are not required custom fields.
...
Creating folder for testcases happens automatically during TestCase creation. However, you can use a separate method for
this action.
...
Contributions to the project are welcome! You can help by reporting bugs, suggesting new features, or submitting pull
...
I'm glad to hear any feedback from you via [Facebook](https://www.facebook.com/maksym.zaverukha.37) or Telegram (
@foggger)
